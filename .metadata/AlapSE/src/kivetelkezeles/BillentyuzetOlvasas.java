...
public class BillentyuzetOlvasas {
	...
	public static void main(String[] args)/* throws IOException */{
		...
		try {
			...
			System.out.println(Calendar.getInstance().get(Calendar.YEAR)-szam + " évben született.");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			//e.printStackTrace();
			System.out.println("Életkor hiba");
	...
	private static void eletKorEllenoriz(int szam) throws Exception {
		if (szam<0 || szam>150) {
			throw new Exception("Életkor túl alacsony vagy magas");
		}
